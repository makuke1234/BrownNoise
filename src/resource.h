...
#define NOISE_SIZE_X (SIZE_X - 2 * BN_MARGIN - DROPNOISEU_SIZE_X - BN_MARGIN)
#define NOISE_SIZE_Y 27

#define DROPNOISEU_POS_X  (SIZE_X - DROPNOISEU_SIZE_X - BN_MARGIN)
...
#define BANDWIDTH_SIZE_X (SIZE_X - 2 * BN_MARGIN - DROPBWUNIT_SIZE_X - BN_MARGIN)
#define BANDWIDTH_SIZE_Y 27

#define DROPBWUNIT_POS_X  (SIZE_X - DROPBWUNIT_SIZE_X - BN_MARGIN)
#define DROPBWUNIT_POS_Y  BANDWIDTH_POS_Y

#define BW_S_SIZE_X BANDWIDTH_SIZE_X
#define BW_S_SIZE_Y 22
...
#define TEMP_SIZE_X (SIZE_X - 2 * BN_MARGIN - DROPTUNIT_SIZE_X - BN_MARGIN)
#define TEMP_SIZE_Y 27

#define DROPTUNIT_POS_X  (SIZE_X - DROPTUNIT_SIZE_X - BN_MARGIN)
#define DROPTUNIT_POS_Y  TEMP_POS_Y

#define TEMP_S_SIZE_X TEMP_SIZE_X
#define TEMP_S_SIZE_Y 22
...
#define DESIREDN_SIZE_X (SIZE_X - 2 * BN_MARGIN - DROPDESIREDN_SIZE_X - BN_MARGIN)
